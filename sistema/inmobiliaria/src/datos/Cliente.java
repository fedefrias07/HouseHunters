...
public class Cliente extends Usuario {
	...
	public void realizarResena(LinkedList<Resena> listaResena, Cliente cliente) {
		    int calificacion = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la calificación del 1 al 5:"));
		    String comentario = JOptionPane.showInputDialog("Ingrese un comentario: ");
		    
		    Resena reseña = new Resena(calificacion, comentario, cliente);
		    listaResena.add(reseña);
		}
	...
	public void verResenas(LinkedList<Resena> listaResena) {
		...
		for (Resena resena : listaResena) {
			...
			JOptionPane.showMessageDialog(null, "estas son las ultimas reseñas realizadas: " + resena);
