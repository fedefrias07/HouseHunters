...
//	+CrearPublicacion()
	...
	public void editarPublicacion(Publicacion publicacion,LinkedList<Publicacion> listaPublicacion) {
	  String opcionEdicion = JOptionPane.showInputDialog("¿Qué desea editar de la publicación?" + "\n1.Zona" + "\n2.Precio" + "\n3.Direccion" + "\n4.Ambientes" + "\5.Caracteristicas"
	    ...
	    switch (opcionEdicion) {
	        case "1":
	            ...
	            break;
	        case "2":
	        	int nuevoPrecio = Integer.parseInt(JOptionPane.showInputDialog("Ingresar nuevo precio: "));
	        ...
	        case "3":
	            ...
	            break;
	        case "4":
	            int nuevoAmbientes = Integer.parseInt(JOptionPane.showInputDialog("Ingresar nuevos ambientes"));
